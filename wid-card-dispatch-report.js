...
(function () {
  ...
  Polymer({
    ...
    /**
     * The `wid-card-dispatch-report-lasers` event is fired whenever `fireLasers` is called.
     *
     * @event wid-card-dispatch-report-lasers
     * @detail {{sound: String}}
     */
    ...
    sayHello: function sayHello(greeting) {
      ...
      return 'wid-card-dispatch-report says, ' + response;
    },
    ...
    fireLasers: function fireLasers() {
      this.fire('wid-card-dispatch-report-lasers', { sound: 'Pew pew!' });
    }
